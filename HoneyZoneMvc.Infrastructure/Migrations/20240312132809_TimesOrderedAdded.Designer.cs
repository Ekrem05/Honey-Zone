...
namespace HoneyZoneMvc.Infrastructure.Migrations
{
    ...
    [Migration("20240312132809_TimesOrderedAdded")]
    partial class TimesOrderedAdded
    {
            ...
            modelBuilder.Entity("HoneyZoneMvc.Infrastructure.Data.Models.DeliveryMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c89c93bb-86c9-4459-b387-3308b00f290c"),
                            Name = "Спиди"
                        },
                        new
                        {
                            Id = new Guid("3fc22d5a-59ce-4f5e-8133-ef692c3b4ad9"),
                            Name = "Eконт"
                        });
                });
            ...
            modelBuilder.Entity("HoneyZoneMvc.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e51206c3-7a01-4e4e-a5ef-eaf9bfebca5f"),
                        ...
                        new
                        {
                            Id = new Guid("4b2bf1ff-0a42-465c-a51f-5a8f88fce343"),
                            CategoryId = new Guid("78355d47-6040-4676-9972-ac8be4f19882"),
                        ...
                        new
                        {
                            Id = new Guid("adbc0d7e-405f-4cc1-a723-784cfa2e2977"),
                            CategoryId = new Guid("78355d47-6040-4676-9972-ac8be4f19882"),
                        ...
                        new
                        {
                            Id = new Guid("ebc70ebb-1311-420e-a6dd-57a537d29ddd"),
                        ...
                        new
                        {
                            Id = new Guid("f46dc869-d498-4278-9e0e-614092b182d4"),
                        ...
                        new
                        {
                            Id = new Guid("78e3952e-9423-4b4a-8a32-82fedf38c150"),
                        ...
                        new
                        {
                            Id = new Guid("c09045ca-2932-4c15-87cb-6859c38de268"),
                            CategoryId = new Guid("eb2aecdd-7815-49aa-973b-ee3173760fc5"),
            ...
            modelBuilder.Entity("HoneyZoneMvc.Infrastructure.Data.Models.State", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("771794d7-10f6-46db-b021-563f60632c90"),
                            Name = "Получена"
                        },
                        new
                        {
                            Id = new Guid("753aef04-ccf5-4d70-9205-03bea9988282"),
                            Name = "В обработка"
                        },
                        new
                        {
                            Id = new Guid("8c15d860-6411-446c-b99f-e114c3f252d5"),
                            Name = "Изпратена"
                        },
                        new
                        {
                            Id = new Guid("7163690d-988e-46b9-8f2f-3633d62b82c5"),
                            Name = "Доставена"
                        },
                        new
                        {
                            Id = new Guid("d49cc193-bf69-43ec-856d-307d1a57f090"),
                            Name = "Отменена"
                        });
                });
